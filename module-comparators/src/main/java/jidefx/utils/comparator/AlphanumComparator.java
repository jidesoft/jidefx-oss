/*
 * @(#)AlphanumComparator.java 5/19/2013
 *
...
public class AlphanumComparator implements Comparator<CharSequence> {
    ...
    public static final ComparatorContext CONTEXT = new ComparatorContext("Alphanum"); //NON-NLS
    public static final ComparatorContext CONTEXT_IGNORE_CASE = new ComparatorContext("Alphanum_Ignorecase"); //NON-NLS
     ...
     */
    private String getChunk(CharSequence s, int length, int marker) {
